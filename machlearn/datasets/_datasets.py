...
class dataset():
    """
    This class provides an interface for accessing dataset that is publicly available in the Internet.
    """
    def __init__(self, dataset_name=None):
        ...
        if self.dataset_name == 'Social_Network_Ads':
            url = urllib.request.urlopen("https://github.com/daniel-yj-yang/Machine-Learning-using-Python/raw/master/Decision-Tree_classification/Social_Network_Ads.csv")
